			  			...
			  			<div class="row">
				            <div class="col-md-3 col-sm-3 col-xs-3">
				                <div class="panel panel-back noti-box">
				                    ...
				                    <div class="text-box">
				                        <p class="main-text"><a class="fs-14" 
				                        href="${pageContext.request.contextPath}/admin/cat/index" title="">Quản lý danh mục</a></p>
				                        <c:if test="${not empty numberOfCat}">
				            ...
				            <div class="col-md-3 col-sm-3 col-xs-3">
				                <div class="panel panel-back noti-box">
				                    ...
				                    <div class="text-box">
				                        <p class="main-text"><a class="fs-14" 
				                        href="${pageContext.request.contextPath}/admin/land/index" title="">Quản lý truyện</a></p>
				                        <c:if test="${not empty numberOfLand}">
				                        	<p class="text-muted">Có ${numberOfLand} truyện</p>
				                        </c:if>		
				                    </div>
				                </div>
				            </div>
				            <div class="col-md-3 col-sm-3 col-xs-3">
				                <div class="panel panel-back noti-box">
				                    ...
				                    <div class="text-box">
				                        <p class="main-text"><a class="fs-14" 
				                        href="${pageContext.request.contextPath}/admin/user/index" title="">Quản lý người dùng</a></p>
				                        <c:if test="${not empty numberOfUser}">
				            ...
				            <div class="col-md-3 col-sm-3 col-xs-3">
				                <div class="panel panel-back noti-box">
				                    ...
				                    <div class="text-box">
				                        <p class="main-text"><a class="fs-14" 
				                        href="${pageContext.request.contextPath}/admin/contact/index" title="">Quản lý liên hệ</a></p>
				                        <c:if test="${not empty numberOfContact}">
				                        	<p class="text-muted">Có ${numberOfContact} liên hệ</p>
				                        </c:if>		
				                    </div>
				                </div>
				            </div>
